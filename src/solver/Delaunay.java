        ...
        for (int i = 0; i < points.length; i++) {
            for (int j = i+1; j < points.length; j++) {
                for (int k = j+1; k < points.length; k++) {
                    ...
                    if (isTriangle) {
                        int point1Cell = data.colRowToVectorized((int)points[i].x(), (int)points[i].y());
                        int point2Cell = data.colRowToVectorized((int)points[j].x(), (int)points[j].y());
                        int point3Cell = data.colRowToVectorized((int)points[k].x(), (int)points[k].y());
