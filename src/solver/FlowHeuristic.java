...
public class FlowHeuristic {
    ...
    public String run(DataStorer data, double crf, double numYears, double captureTarget, String basePath, String dataset, String scenario) {
        // create directory
    ...
    private double makeSolveLP2(DataStorer data, double crf, double numYears, double captureTarget, String solutionDirectory, int iterationNum, int phase, boolean localImprovement) {
        ...
        try {
            ...
            if (solutionDirectory != null && solutionDirectory != "") {
                ...
                try{
                    Solution soln = data.loadSolution(solutionDirectory, -1, "solution.sol");
                    cost = soln.getTotalCost();
                } catch(Exception e) {
                    System.out.println("Cplex error: Flow is over capacity.");
                }
